  ...
  (() => {
    ...
    function u(e = {}, t = {}) {
      Object.keys(t).forEach((s) => {
        void 0 === e[s]
          ? (e[s] = t[s])
          : c(t[s]) && c(e[s]) && Object.keys(t[s]).length > 0 && u(e[s], t[s]);
      });
    }
    const p = {
      body: {},
            ...
            void 0 !== n &&
              ...
              (L(t[i]) && L(r[i])
                ? r[i].__swiper__
                  ...
                  : _(t[i], r[i])
                : !L(t[i]) && L(r[i])
                ? ((t[i] = {}), r[i].__swiper__ ? (t[i] = r[i]) : _(t[i], r[i]))
                : (t[i] = r[i]));
          }
        }
      }
    ...
    const j = {
      loopCreate: function () {
        ...
        for (let e = o.length - 1; e >= 0; e -= 1)
          n.prepend(x(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      },
      loopFix: function () {
        const e = this;
    ...
    const ee = {
      setBreakpoint: function () {
        ...
        p && s && e.changeDirection(), _(e.params, l);
      ...
      t({
        ...
        s("click", (t, s) => {
          const { $nextEl: n, $prevEl: r } = e.navigation,
            o = s.target;
          if (e.params.navigation.hideOnClick && !x(o).is(r) && !x(o).is(n)) {
            if (
              e.pagination &&
              e.params.pagination &&
      ...
      function d() {
        ...
        if (
          ("fraction" === s.type &&
            ...
            d.find(ce(s.totalClass)).text(s.formatFractionTotal(u))),
          "progressbar" === s.type)
        ) {
          let t;
      ...
      function a() {
        ...
        if (
          ...
          t.children(`.${s.slideVisibleClass}`).each((e) => {
            o(a ? x(e).attr("data-swiper-slide-index") : x(e).index());
          });
    ...
    function he() {
      !(function () {
        ...
        document.querySelector(".body-main-slider__slider") &&
          new ae(".body-main-slider__slider", {
            modules: [de, pe],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
        ...
        document.querySelector(".new-dishes-slider__slider") &&
          new ae(".new-dishes-slider__slider", {
            modules: [de, pe],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
            ...
            lazy: !0,
            navigation: {
              nextEl: ".new-dishes-slider__buttons .main-buttons__button_next",
              prevEl: ".new-dishes-slider__buttons .main-buttons__button_prev",
            },
            on: {},
          }),
        document.querySelector(".slider-special-menu__slider") &&
          new ae(".slider-special-menu__slider", {
            modules: [pe, ue],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
    ...
    var we = function (e, t, s, i) {
      ...
      We = "lgDragMove",
      Ve = "lgDragEnd",
      Re = "lgBeforeNextSlide",
      Ye = "lgBeforePrevSlide",
      Xe = "lgBeforeClose",
      Ue = "lgAfterClose",
      Ke = 0,
      Qe = (function () {
        ...
        return (
            ...
            if (!(this.$container && this.$container.get())) {
              ...
              var n = this.settings.ariaLabelledby
                ...
                d =
                  ...
                  "\n                </div>\n            </div>\n        </div>\n        ";
              ve(this.settings.container).css("position", "relative").append(d),
          ...
          (e.prototype.openGallery = function (e, t) {
            ...
            if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
              ...
              this.zoomFromOrigin &&
                ...
                (r = Ce(t, this.outer, a, l, this.currentImageSize))),
          ...
          (e.prototype.goToPrevSlide = function (e) {
            ...
            e && this.galleryItems.length < 3 && (s = !1),
              this.lgBusy ||
                (this.index > 0
                  ? (this.index--,
                    this.LGel.trigger(Ye, { index: this.index, fromTouch: e }),
          ...
          (e.prototype.closeGallery = function (e) {
            ...
            this.LGel.trigger(Xe), ve(window).scrollTop(this.prevScrollTop);
            var s,
            ...
            return (
              ...
              setTimeout(function () {
                t.zoomFromOrigin &&
                  ...
                  t.$inner.empty(),
                  t.lgOpened && t.LGel.trigger(Ue, { instance: t }),
    ...
    (et.prototype.init = function () {
      ...
      (et.prototype.mediaHandler = function (e, t) {
        if (e.matches)
      ...
      (et.prototype.moveTo = function (e, t, s) {
      ...
      (et.prototype.moveBack = function (e, t, s) {
        t.classList.remove(this.daClassname),
          void 0 !== e.children[s]
            ? e.children[s].insertAdjacentElement("beforebegin", t)
            : e.insertAdjacentElement("beforeend", t);
      }),
      (et.prototype.indexInParent = function (e, t) {
        const s = Array.prototype.slice.call(e.children);
        return Array.prototype.indexOf.call(s, t);
      }),
      (et.prototype.arraySort = function (e) {
        "min" === this.type
